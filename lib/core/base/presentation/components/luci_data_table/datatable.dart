                ...
                child: ConstrainedBox(
                  ...
                  child: DataTable(
                    headingRowColor: MaterialStateProperty.resolveWith(
                        (states) => (AppColor.mCInk50)),
                    key: _tableKey,
                    headingTextStyle: AppStyles.mSTH400,
                    dataTextStyle:
                        AppStyles.mSTBaseLineNormal.copyWith(fontSize: 14),
...
/*                    border: TableBorder.all(
  ...
  Widget createTableFooter() {
    ...
    final lastRequestDetails = widget.source.lastDetails!;
    final rowsForPager =
        lastRequestDetails.filteredRows ?? lastRequestDetails.totalRows;
    final totalPages = rowsForPager ~/ widget.rowsPerPage;
    final currentPage = (_firstRowIndex ~/ widget.rowsPerPage) + 1;
    ...
    if (userFooterWidget == null) {
      ...
      final footerTextStyle =
          AppStyles.mSTH300.copyWith(color: AppColor.mCBlue400);
        ...
        footerWidgets.addAll(<Widget>[
          Row(
            ...
            children: [
              ...
              Text('Hiển thị',
                  style: AppStyles.mSTH300.copyWith(color: AppColor.mCInk900)),
              ConstrainedBox(
                ...
                child: Align(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: AppColor.mCInk100,
                        borderRadius:
                            BorderRadius.circular(AppDimens.mRadiusSmall4)),
                    child: DropdownButtonHideUnderline(
                      ...
                      child: DropdownButton<int>(
                        ...
                        onTap: () {},
                        iconSize: 16,
                        iconEnabledColor: AppColor.mCBlue400,
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                ...
                disabledColor: AppColor.mCInk400,
                        ...
                        child: IconButton(
                          onPressed: e != currentPage
                              ? () {
                                  ...
                                  widget.source.setNextView(
                                    startIndex: (e - 1) * widget.rowsPerPage,
                                  );
                                }
                              : null,
                          icon: Text(
                            e.toString(),
                            style: AppStyles.mSTH300.copyWith(
                              color: e == currentPage
                                  ? AppColor.mCWhite
                                  : AppColor.mCInk900,
                            ),
...
/*            child: SingleChildScrollView(
  ...
  String buildDataAmountText() {
    ...
    if (widget.source.lastDetails != null &&
      ...
      amountText += ' from (${widget.source.lastDetails!.totalRows}) bản ghi';
    }
